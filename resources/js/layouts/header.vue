        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            <div class="navbar-header">
                <router-link class="navbar-brand" to="/">
                    <b>
                        <img :src="getSidebarLogo" alt="" class="sidebar-logo dark-logo"/>
                        <img :src="getSidebarLogo" alt="" class="sidebar-logo light-logo"/>
                    </b>
                    <span>
                     <img :src="getMainLogo" alt="" class="dark-logo default-logo"/>
                     <img :src="getMainLogo" class="light-logo default-logo" alt=""/></span>
                </router-link>
            </div>
            <div class="navbar-collapse">
                <ul class="navbar-nav mr-auto mt-md-0 ">
                    ...
                    <li class="nav-item" v-tooltip.right="trans('general.toggle_sidebar')"><a
                            class="nav-link sidebartoggler hidden-sm-down text-muted waves-effect waves-dark"
                            href="javascript:void(0)"><i class="icon-arrow-left-circle fas"></i></a></li>
                </ul>
                <ul class="navbar-nav my-lg-0">
                    <li class="nav-item" v-tooltip.bottom="trans('configuration.configuration')"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                :src="getAuthUser('avatar')" alt="user" class="profile-pic"/></a>
                        <div :class="['dropdown-menu', getConfig('user_direction') != 'rtl' ? 'dropdown-menu-right' : '']">
                            <ul class="dropdown-user">
                                ...
                                <li>
                                    <router-link to="/change-password"><i class="fas fa-key"></i>
                                        {{trans('user.change_password')}}
                                    </router-link>
                                </li>
                                <li role="separator" class="divider"></li>
                                <li><a href="#" @click.prevent="logout"><i class="fas fa-power-off"></i>
                                    {{trans('auth.logout')}}</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
...
<style>
    .navbar-header .navbar-brand .sidebar-logo {
        max-width: 50px;
    }
</style>
