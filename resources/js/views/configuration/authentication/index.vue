                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label for="">{{trans('auth.session_lifetime')+' '+trans('auth.in_minute')}} <show-tip module="auth" tip="tip_session_lifetime" type="field"></show-tip></label>
                                                    <input class="form-control" type="number" value="" v-model="configForm.session_lifetime" name="session_lifetime" :placeholder="trans('auth.session_lifetime')">
                                                    <show-error :form-name="configForm" prop-name="session_lifetime"></show-error>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
